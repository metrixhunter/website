...
export default function BalancePage() {
  ...
  const handleBankClick = (bankName) => {
    router.push(`/banks/${bankName.toLowerCase()}`);
  };

  return (
    <Container maxWidth="xs" sx={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <Paper elevation={3} sx={{ width: '100%', borderRadius: 4, bgcolor: '#fff', textAlign: 'center', px: 0, py: 3 }}>
        ...
        <List>
          {user?.upiBalance > 0 && (
            <ListItem
              sx={{ py: 1.4, px: 2, bgcolor: '#e2f6ff', mb: 0.5, border: '2px solid #1976d2', borderRadius: 2 }}
            >
              <ListItemAvatar>
              ...
              <ListItemText
                ...
                secondary={<Typography variant="body2" color="text.secondary">Linked UPI</Typography>}
              />
            </ListItem>
          )}
          ...
          {user?.banks.map((bank, idx) => (
            <ListItem
              ...
              secondaryAction={
                <IconButton edge="end" aria-label="go" onClick={() => handleBankClick(bank.bankName)}>
            ...
            >
              ...
              <ListItemText
                ...
                secondary={<Typography variant="body2" color="text.secondary">Bank Account</Typography>}
              />
            </ListItem>
          ))}
        </List>
        ...
        <Stack spacing={1} px={2}>
          <Box sx={{ py: 1, px: 2, bgcolor: '#e3f2fd', borderRadius: 2, textAlign: 'left', display: 'flex', alignItems: 'center', gap: 1 }}>
